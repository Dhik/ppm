...
@section('content')
<div class="site-blocks-cover overlay inner-page-cover" style="background-image: url(main/images/agro.jpg); background-attachment: fixed;">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">

          <div data-aos="fade-up">
            <h1 class="text-white font-weight-light">PPM Agrokompleks</h1>
          </div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center">
            <h2 class="font-weight-light text-black">PPM Agrokompleks</h2>
            <p class="color-black-opacity-5">Tim keprofesian yang bergerak dalam kumpulan bidang pertanian, peternakan, perikanan, perkebunan dan kehutanan</p>
          </div>
        </div>
    </div>
    </div>
