  ...
  @include('admin.pages.booklet.sidebar')
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <h1 class="text-center title-berkshire fact-title-color" style="font-size:70px;">Facts</h1>
        <h5 class="text-center montserrat" style="color:white; letter-spacing: 7px;">PPM Nurul Hakim</h5>
        <div class="card-deck">
